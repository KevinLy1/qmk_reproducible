...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_60_ansi(
        ...
        MO(3), KC_LEFT, KC_DOWN, KC_RIGHT, KC_PSCR, KC_NO, KC_NO, KC_NO, RM_PREV, RM_NEXT, RM_VALD, RM_VALU, KC_ENT,
    ...
    [2] = LAYOUT_60_ansi(
        KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_DEL,
        KC_TAB, KC_HOME, KC_UP, KC_END, KC_DEL, KC_INS, KC_SCRL, KC_PAUS, KC_NO, KC_HOME, KC_END, KC_PGUP, KC_PGDN, KC_PSCR,
        KC_NO, KC_LEFT, KC_DOWN, KC_RIGHT, KC_PSCR, KC_NO, KC_NO, KC_NO, RM_PREV, RM_NEXT, RM_VALD, RM_VALU, KC_ENT,

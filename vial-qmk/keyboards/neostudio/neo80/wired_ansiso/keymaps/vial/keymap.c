...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_TAB,  KC_HOME, KC_UP,   KC_END,  KC_DEL,  KC_INS,  KC_SCRL, KC_PAUS, KC_NO,   KC_HOME, KC_END,  KC_PGUP, KC_PGDN, UG_VALU,                   KC_DEL,  KC_END,  KC_PGDN,
        KC_NO,   KC_LEFT, KC_DOWN, KC_RIGHT,KC_PSCR, KC_NO,   KC_NO,   KC_NO,   KC_NO,   UG_PREV, UG_NEXT, UG_VALD,          KC_PSCR,            
